...
* **Analysis summary**: I first read in the csv, then changed the data type of the amount column. Then I needed to filter by date and by name. I did each one in their own dataframe to keep it as clear as possible. My analysis matched the article and I got all of the same answers as them. 
...
* **Analysis summary**: [My analysis showed that during the session from May 16 to June 29, the two executivves gave a combined $41,250. I am not sure if the authors of the article rounded their results for readability, but I had the total about 250 dollars different than the article. It also seems that the article made a mistake in saying that they donated these figures during the last REGULAR legislative session. According to ballotpedia (https://ballotpedia.org/2018_North_Carolina_legislative_session), the last regular session at the time of the article went from January 10 - July 4. The two executives donated significantly more than 41k during that time.]
...
#Summarize and Display Donations
