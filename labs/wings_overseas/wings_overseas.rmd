...
tea_stats_combined <- tea_stats_combined %>% 
  mutate(Last =("Tea")) %>% 
  mutate(First ="McCowan")
  
```
## All Players 
```{r}
all_games_combined <- bind_rows(list(kuier_stats_combined, satou_stats_combined, collier_stats_combined, mabrey_stats_combined, tea_stats_combined))
```
