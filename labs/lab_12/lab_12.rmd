...
sub <- paste("On", format(latest_date$date, format="%B %d"), " ", "A Suspicious Event Occured. It was the", format(one_month_ago), "time it has occured in the previous 30 days", sep="")
sub
