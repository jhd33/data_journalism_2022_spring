...
**Answer**
There are 195,865 loans in the dataset. 
```{r}
# Load data
...
**Answer**
One significant problem is that the cities are spelled in a number of different ways and formats. So the detect is not doing enough, as there are other spelling issues to clean up, and there are other differences in capitalization as well. 
```{r}
...
**Answer*
For both Phoenix and Westminster, the code changed the spelling from all caps to regular capitalization. 
...
**Answer**
ABERDEEN and aberdeen were changed to Aberdeen. Abell was changed from all caps to regular capitalization. And Aberdeen Proving Ground was corrected for capitalization as well. 
```{r}
cleaned_md_loans %>%
