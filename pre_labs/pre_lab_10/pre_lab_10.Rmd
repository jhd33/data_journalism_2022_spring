...
https://datawrapper.dwcdn.net/uKKVh/1/
...
The code is grouping by county and then finding the number of loans in each county. 
...
**Answer** Describe what the code below is doing and the output.
This filter gets rid of the super small counties, which in reality are just counties that do not exist in Maryland. 
...
Every county is assigned a five digit code. 
...
You see county information and the count of how many loans were found in that county. 
...
The map now focuses on Maryland. 
...
**Answer** Describe the changes from the previous map
When you hover over the county, it now has the name rather than the fips code. 
...
https://datawrapper.dwcdn.net/QbJKs/1/
