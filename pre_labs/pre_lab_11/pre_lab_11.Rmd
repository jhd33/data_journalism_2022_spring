...
**Answer**
I see a collection of files in one folder. 
```{r, echo=FALSE}
...
**Answer**
I see a lot of data from the files. 
...
**Answer**
The data is now filtered for Maryland, and there are a number of different tables in the data below. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Below is a tibble that describes the data when grouping by type. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
More data, this time filtered by State and type. 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
This is a geographic chart of hospitals, but into x,y coordinates on a table. 
```{r}
md_hospitals %>%
  ggplot() + 
  geom_sf() + 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The following comes up: To enable caching of data, set `options(tigris_use_cache = TRUE)`
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Below is a dataset that shows 18 columns and 3234 rows.
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The result us a map of maryland that does not include water.
```{r}
md_counties %>%
  ggplot() + 
  geom_sf() + 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The map now has the locations of hospitals. 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The map is now color coded to show the bedspace of the hospitals. 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Below is data that is not yet a data frame. 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
This is a dataframe of total beds by county. 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
This shows population data by county. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Again, the data below is a shapefile. 
```{r}
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The output is a dataframe with beds by county. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Below is a shapefile with cleaned names. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
Now the data is joined with the beds by county. 
...
Our final step before visualization, let's calculate the number of beds per 100,000 for each county and sort from highest to lowest to see what trends we can identify just from the table. 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
A chloropleth map of Maryland is below. 
```{r}
ggplot() + 
...
**Task** Run the following code. Describe the output in the space below.
**Answer**
The color is now changed. Most of the state looks to be the same. 
```{r}
ggplot() + 
  geom_sf(data=md_beds_per_100k, aes(fill=beds_per_100k)) + 
  theme_minimal() +
...
**Answer**
Now the sclae on the side is different. The state now looks different in various spots. 
```{r}
ggplot() + 
  geom_sf(data=md_beds_per_100k, aes(fill=beds_per_100k)) + 
  theme_minimal() +
