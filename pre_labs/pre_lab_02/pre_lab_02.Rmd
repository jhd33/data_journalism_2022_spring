...
**Answer**
The payroll proceeds percentage was 100%. 
...
What is the payroll proceeds percentage for the first result? Put your answer in the space below.
**Answer**
The payroll percent was zero percent. 
...
mutate(
  jobs_retained_category = case_when(
    ...
    jobs_retained >= 25 & jobs_retained < 50 ~ '50_to_100',
    jobs_retained >= 50 & jobs_retained < 100 ~ '100_to_250',
    jobs_retained >= 100 & jobs_retained < 500 ~ '250_to_500',
...
**Answer**
The datatype is chr, which stands for character. 
...
**Answer**
April 2020 had the most applications. That month had 45,042 applications. 
