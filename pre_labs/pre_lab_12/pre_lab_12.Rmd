...
**Answer**
The dataframe shows the changes in vaccinations in each Maryland county over time. 
```{r}
...
**Answer**
Yes, there are a significant number of vaccines with the NA listed in the county column. 
...
**Answer**
This shows all the individual dates with the counties listed as NA. It could represent things like out of state individuals or put of county individuals getting their vaccines in Maryland.  
...
**Answer**
In the most recent 7-10 days, some of the lowest numbers of full vaccinations have been recorded since the dataset began. 
...
**Answer**
The data peaked from April to July, and has been decreasing since then with only minor peaks. 
...
**Answer**
The resulting chart shows the growth in COVID cases over time, sorted by counties in Maryland. 
...
**Task** Run the following code and describe what the resulting chart shows
**Answer**
This is the same chart but flipped and shown with a logorithmic scale. 
...
**Answer**
The map is showing covid cases by county, which shows that PG and Montgomery counties have the highest totals. 
