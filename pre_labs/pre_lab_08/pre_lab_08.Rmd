...
```{r echo=FALSE}
census_api_key("46337cfa9ca4bb84fc53936d51e61e3bdb6e6b3e", install=TRUE)
```
...
**Answer**
The largest percentage change was Nevada. 
...
**Answer**
Howard County ahs the highest estimated median income. 
...
**Answer**
Yes, no matter where in the range it falls, it is still significantly richer than other states. 
...
**Answer**
Somerset and Caroline Counties saw their incomes fall. The change is within the margin of error. 
```{r}
md10 %>%
...
**Answer**
The three zip codes are 21202, 21201, and 21740. 
